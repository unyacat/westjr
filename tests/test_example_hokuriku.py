...
jr = westjr.WestJR(line="hokuriku", area="hokuriku")
...
def test_convert_stopTrains() -> None:
    ...
    駅名と停車する列車種を抽出
    """
    station = jr.get_stations(line="hokuriku").stations[0]
    assert station.info.name == "敦賀"
...
def test_convert_pos() -> None:
    ...
    train = jr.get_trains(line="hokuriku").trains[0]
